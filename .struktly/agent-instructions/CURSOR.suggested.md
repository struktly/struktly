...
title: "Struktly Agent Instructions (cursor)"
...
Copy reviewed content into `.cursor/rules/` or your active Cursor rules. Struktly never overwrites active agent instruction files automatically.
