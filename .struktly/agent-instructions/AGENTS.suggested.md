...
title: "Struktly Agent Instructions (generic)"
...
Copy reviewed content into repo-root `AGENTS.md`. Struktly never overwrites active agent instruction files automatically.
