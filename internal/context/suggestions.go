...
func (d *instructionDraft) renderMarkdown(target string) string {
	...
	b.WriteString(files.OKFFrontmatter("agent-instructions", "Suggested Agent Instructions ("+target+")", "Generated by struktly suggest-instructions.", d.generatedAt))
	b.WriteString("# Suggested Agent Instructions\n\n")
	...
	b.WriteString("## Context Workflow\n\n")
