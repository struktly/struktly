...
func TestScanWritesProjectContext(t *testing.T) {
	...
	writeFile(t, root, ".struktly/direction.md", "---\ntype: direction\n---\n\n# Current Direction\n\nLocal-first context and evidence.\n")
	writeFile(t, root, "docs/product/current-direction.md", "# Legacy direction doc\n")
	...
	assertContains(t, content, "- `docs/product/current-direction.md`")
	...
	assertContains(t, content, "Local-first context and evidence.")
	...
	assertContains(t, content, "## Open Questions / Missing Metadata")
