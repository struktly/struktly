...
`)
	...
	writeFile(t, root, ".struktly/decisions.md", "# Decisions\n\n## 2026-07-04 — Keep JSON stable\n\n**Decision:** Version every machine-readable format.\n\n**Status:** accepted\n\n---\n\n## 2026-07-04 — Open idea\n\n**Decision:** Add XML output.\n\n**Status:** proposed\n")
...
**Decision:** Keep JSON output versioned.
...
`)
	...
	if !strings.Contains(decisions[0], "Keep JSON output versioned.") {
