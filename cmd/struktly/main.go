...
func newRootCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:           "struktly",
		Short:         "Local, Git-native context control plane for coding-agent work",
		SilenceUsage:  true,
		SilenceErrors: true,
	}
...
func newInitCmd(repoRoot *string) *cobra.Command {
	return &cobra.Command{
		Use:   "init",
		Short: "Scaffold .struktly/ seed files and write project context",
		RunE: func(cmd *cobra.Command, _ []string) error {
...
func newRunCmd(repoRoot *string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "run",
		Short: "Record local-first agent-oriented work runs",
	}
...
func newRunCreateCmd(repoRoot *string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "create",
		Short: "Create a durable run record under .struktly/runs/",
		RunE: func(cmd *cobra.Command, _ []string) error {
